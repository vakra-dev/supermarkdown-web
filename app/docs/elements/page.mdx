export const metadata = {
  ...
  description:
    'Full list of HTML elements supported by supermarkdown and their Markdown output. Block elements, inline elements, tables, and more.',
  alternates: { canonical: 'https://supermarkdown.dev/docs/elements' },
  openGraph: {
    title: 'Supported Elements - supermarkdown',
    description:
      'Full list of HTML elements supported by supermarkdown and their Markdown output. Block elements, inline elements, tables, and more.',
    url: 'https://supermarkdown.dev/docs/elements',
