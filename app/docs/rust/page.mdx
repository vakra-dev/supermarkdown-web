...
Typical performance: **~5x faster** than JavaScript alternatives ([benchmarks](https://github.com/vakra-dev/supermarkdown/tree/main/bench)).

## Used in Production

Supermarkdown is open source and powers parts of [Reader's web context pipeline](https://reader.dev/open-source).
